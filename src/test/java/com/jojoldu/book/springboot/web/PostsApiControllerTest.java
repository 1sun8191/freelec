...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)     //test시 톰캣을 random 포트로 실행
...
//        System.out.println("responseEntity.getClass() = " + responseEntity.getClass());
